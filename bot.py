...
# ==============================================================================
# ВСТРОЕННАЯ ПОСТОЯННАЯ БАЗА (DEFAULT)
# ==============================================================================
DEFAULT_SUPPORT_PHRASES = [
    "Помни... Ты не один.",
    "Помни... Спасибо, что поделился. Ты значим.",
    ...
    "Помни... Ты не обязан справляться со всем в одиночку.",
    "Помни... То, что ты чувствуешь, имеет право быть.",
    "Помни... Ты уже прошёл через многое и справишься с этим тоже.",
    "Помни... Не торопись, у тебя есть время.",
    "Помни... Ты не отстаёшь, ты идёшь в своём темпе.",
    "Помни... Ты значим.",
    "Помни... Ты не урод и не фрик. Ты просто ты, и этого достаточно.",
    "Помни... Просить о помощи — нормально.",
    "Помни... Если тебе нужно время, возьми его.",
    "Помни... Ты важен, и это не изменится.",
    "Помни... Даже маленький шаг вперёд — это шаг вперёд.",
    "Помни... Ты имеешь право искать свой путь.",
    "Помни... Даже если сейчас всё запутано, так будет не всегда.",
    "Помни... Один плохой день не отменяет весь твой путь.",
    "Помни... Тебе не обязательно знать все ответы прямо сейчас.",
    "Помни... Изменения могут происходить тихо и постепенно.",
    "Помни... Отдых — это не провал.",
    "Помни... То, что тебе тяжело, не делает тебя слабым.",
    "Помни... Ты уже находишься в процессе изменений.",
    "Помни... Трудные периоды проходят.",
    "Помни... Даже если сейчас кажется, что ничего не получается, каждый шаг имеет значение.",
    "Помни... Тебя видят и ты значим.",
    "Помни... Тебе не нужно заслуживать право на заботу.",
    "Помни... Сложные эмоции не делают тебя плохим человеком.",
    "Помни... Не сравнивай свой путь с чужим.",
    "Помни... Иногда достаточно просто позаботиться о себе сейчас.",
    "Помни... Твоя ценность не зависит от продуктивности.",
    "Помни... Ты хороший человек, даже если сейчас так не кажется.",
    "Помни... Тебе можно менять мнение и искать себя.",
    "Помни... Этот момент временный.",
    "Помни... Тебе не нужно соответствовать чужим ожиданиям.",
    "Помни... Твой опыт реален, даже если другие его не понимают.",
    "Помни... Просить помощи — это забота о себе.",
    "Помни... То, что что-то даётся сложнее, не делает тебя менее способным.",
    "Помни... Твои особенности не уменьшают твою ценность.",
    "Помни... Не каждый день должен быть продуктивным.",
    "Помни... Ты не обязан объяснять каждую часть себя.",
    "Помни... Маленькие достижения тоже достижения.",
    "Помни... Твои потребности важны.",
    "Помни... Тебе разрешено делать паузы и менять планы.",
    "Помни... Быть другим — не значит быть неправильным.",
    "Помни... Ты заслуживаешь места, где можно быть собой.",
    "Помни... Не нужно постоянно бороться.",
    "Помни... В тебе больше, чем твои диагнозы или трудности.",
    "Помни... Даже самый тяжёлый момент не длится вечно.",
    "Помни... Ты больше, чем один диагноз, ошибка или плохой день.",
    "Помни... Иногда просто прожить день — уже достижение.",
    "Помни... Твоя история ещё продолжается.",
    "Помни... Ты можешь начать заново.",
    "Помни... Твои границы важны.",
    "Помни... Тебе можно быть уязвимым.",
    "Помни... Твой голос имеет значение.",
    "Помни... Ты заслуживаешь понимания.",
    "Помни... Не нужно быть идеальным, чтобы быть ценным.",
    "Помни... Помощь существует, и обращаться за ней нормально.",
    "Помни... Ты достоин доброты.",
    "Помни... Ты имеешь право быть собой.",
    "Помни... Тебе не нужно проходить через всё одному.",
    "Помни... Ты уже сделал больше, чем тебе кажется.",
    "Помни... Ты не обязан бороться каждый день.",
    "Помни... Маленькая забота о себе тоже имеет значение.",
    "Помни... У тебя есть право остановиться и восстановиться.",
    "Помни... Твоя ценность не зависит от чужого мнения.",
    "Помни... Быть собой — уже достаточно.",
    "Помни... Даже если прогресс незаметен, он может происходить.",
    "Помни... Ты не обязан быть сильным всё время.",
    "Помни... Сегодняшнее состояние не определяет всю твою жизнь."
]

DEFAULT_SUPPORT_IMAGES = [
    "https://i.postimg.cc/3NmgV8tR/7b4583d8c0a7e1644e971b3112c394ea.jpg",
    "https://i.postimg.cc/fTQ7XdbQ/5b4d069f62213dc401f60cbffdd984a0.jpg",
    "https://i.postimg.cc/76VC25tb/6fd8d6ea910c9518326817c7a97224ac.jpg",
    "https://i.postimg.cc/yxpkLwzr/4212a54cfa0010528e92fda6e4637719.jpg",
    "https://i.postimg.cc/kXDV2XxH/f7da4e4f28096ab63a12dd5188fc1ecb.jpg",
    "https://i.postimg.cc/JzkGQ6Yd/92f1c9f0288b992b061a1c298ec87939.jpg",
    "https://i.postimg.cc/ydVxsV6z/217c5ab52c6f1a47bb4e85d9d792a288.jpg",
    "https://i.postimg.cc/Y00SLbmz/4a9d7374882b21a5f0559bef79bc6433.jpg",
    "https://i.postimg.cc/5yr2BLBN/05d87c3bfac683e149ada8c80e1943fd.jpg",
    "https://i.postimg.cc/jq32Y0GB/f8ef175a0fdff2f3c245eff12055185d.jpg",
    "https://i.postimg.cc/Fs2K1bF7/5e9cc1a27ff6dda01c2481b5ac28e7d1.jpg",
    "https://i.postimg.cc/3xmxGyWz/244f6d55621da21c58add8c17ffc1c38.jpg",
    "https://i.postimg.cc/VNFs73q4/c93f6381c4007a48a2023790d3b982bd.jpg",
    "https://i.postimg.cc/XJ7jtQxZ/5f5203ad11b18900263354293f089136.jpg"
]
...
CUSTOM_ARTS_FILE = "custom_cat_arts.json"
CUSTOM_PHRASES_FILE = "custom_support_phrases.json"
...
CATEGORY_ORDER = ["расстройства", "нейроотличие"]

# ==============================================================================
# МЕНЮ ЭКСТРЕННОЙ ПОМОЩИ
# ==============================================================================
def send_help_resources(chat_id: int) -> None:
    text = (
        ...
        "🇺🇦 <b>Україна</b>\n"
        "☎️ 112 — єдиний номер екстрених служб.\n"
        "☎️ Lifeline Ukraine:\n"
        "☎️ Лінія емоційної підтримки:\n\n"
        "🇧🇾 <b>Беларусь</b>\n"
        "☎️ Экстренная психологическая помощь:"
    )
    kb = types.InlineKeyboardMarkup(row_width=1)
    
    def make_phone_button(label: str, phone: str):
        cleaned_phone = phone.replace(" ", "").replace("(", "").replace(")", "")
        try:
            return types.InlineKeyboardButton(label, copy_text=types.CopyTextButton(text=cleaned_phone))
        except AttributeError:
            return types.InlineKeyboardButton(label, url=f"tel:{cleaned_phone}")

    kb.add(make_phone_button("🇷🇺 +7 (495) 989-50-50", "+7 (495) 989-50-50"))
    kb.add(make_phone_button("🇺🇦 112", "112"))
    kb.add(make_phone_button("🇺🇦 7333", "7333"))
    kb.add(make_phone_button("🇺🇦 0 800 211 444", "0 800 211 444"))
    kb.add(make_phone_button("🇧🇾 133", "133"))
    kb.add(types.InlineKeyboardButton("ℹ️ Подробнее о ресурсах помощи", url="https://t.me/PsychoPromblem/3475"))
...
# ---------- Хештеги ----------
MENTAL_HEALTH_TAGS = ["тревога", "паранойя", "срыв", "паническиеатаки", "диссоциация", "мелтдаун", "выгорание", "бессонница", "гиперфиксация"]
...
LIFE_TAGS = ["интерактив", "другое", "мем", "полезное"]
...
# ==============================================================================
# РАБОТА С ФРАЗАМИ И ИЗОБРАЖЕНИЯМИ (DEFAULT + CUSTOM)
# ==============================================================================
def load_list_file(path: str) -> list:
...
CUSTOM_SUPPORT_PHRASES = load_list_file(CUSTOM_PHRASES_FILE)
CUSTOM_SUPPORT_IMAGES = load_list_file(CUSTOM_ARTS_FILE)

def get_all_phrases() -> list:
    # Объединяем дефолтные и кастомные фразы без дубликатов
    return list(dict.fromkeys(DEFAULT_SUPPORT_PHRASES + CUSTOM_SUPPORT_PHRASES))

def get_all_cat_arts() -> list:
    # Объединяем дефолтные и кастомные арты без дубликатов
    return list(dict.fromkeys(DEFAULT_SUPPORT_IMAGES + CUSTOM_SUPPORT_IMAGES))

# Словарь для предотвращения повтора одной и той же комбинации для пользователя
user_last_support_sent = {}

def send_support_gift(user_id: int) -> None:
    phrases = get_all_phrases()
    arts = get_all_cat_arts()

    if not phrases and not arts:
        return

    last_phrase, last_art = user_last_support_sent.get(user_id, (None, None))

    # Выбор фразы без повтора подряд
    ...
    # Выбор арта без повтора подряд
    if len(arts) > 1 and last_art in arts:
        available_arts = [a for a in arts if a != last_art]
        art_url = random.choice(available_arts)
    else:
        art_url = random.choice(arts) if arts else None

    # Запоминаем отправленное
    user_last_support_sent[user_id] = (phrase, art_url)
...
def cmd_addphrase(message: types.Message) -> None:
    if not is_admin(message.from_user.id):
        return
    phrase = message.text.replace("/addphrase", "", 1).strip()
    if not phrase:
        bot.send_message(message.chat.id, "⚠️ Использование: `/addphrase Помни... Текст фразы`", parse_mode="Markdown")
        return

    with DATA_LOCK:
        if phrase not in CUSTOM_SUPPORT_PHRASES:
            CUSTOM_SUPPORT_PHRASES.append(phrase)
            save_list_file(CUSTOM_PHRASES_FILE, CUSTOM_SUPPORT_PHRASES)
            bot.send_message(message.chat.id, f"✅ Новая пользовательская фраза добавлена!\nВсего фраз в системе: {len(get_all_phrases())}")
        else:
            bot.send_message(message.chat.id, "⚠️ Эта фраза уже есть в базе.")
...
def cmd_addcatart(message: types.Message) -> None:
    ...
    art_val = None
    if message.photo:
        art_val = message.photo[-1].file_id
    else:
        text_val = message.text.replace("/addcatart", "", 1).strip()
        if text_val:
            art_val = text_val

    if not art_val:
        bot.send_message(message.chat.id, "⚠️ Отправьте фото с подписью `/addcatart` или ссылку `/addcatart URL`")
        return

    with DATA_LOCK:
        if art_val not in CUSTOM_SUPPORT_IMAGES:
            CUSTOM_SUPPORT_IMAGES.append(art_val)
            save_list_file(CUSTOM_ARTS_FILE, CUSTOM_SUPPORT_IMAGES)
            bot.send_message(message.chat.id, f"✅ Новое изображение поддержки добавлено!\nВсего артов в системе: {len(get_all_cat_arts())}")
        else:
            bot.send_message(message.chat.id, "⚠️ Это изображение уже есть в базе.")
...
def render_preview_text(draft: dict) -> str:
    ...
    pub_type_title = PUB_TYPES.get(draft.get("pub_type"), "Публикация")
...
def build_wizard_keyboard(draft: dict) -> types.InlineKeyboardMarkup:
    ...
    if step == "type_select":
        kb.add(types.InlineKeyboardButton("Отправить тейк", callback_data=f"{CB_PREFIX_PUB_TYPE}take"))
        kb.add(types.InlineKeyboardButton("Интерактив", callback_data=f"{CB_PREFIX_PUB_TYPE}interactive"))
        kb.add(types.InlineKeyboardButton("Мем", callback_data=f"{CB_PREFIX_PUB_TYPE}meme"))
        kb.add(types.InlineKeyboardButton("Полезное", callback_data=f"{CB_PREFIX_PUB_TYPE}useful"))
        kb.add(types.InlineKeyboardButton("Другое", callback_data=f"{CB_PREFIX_PUB_TYPE}other"))
    ...
    elif step == "take_hashtags":
        available_tags = []
        for cat in draft["categories"]:
            available_tags.extend(TAGS.get(cat, []))
        if not available_tags:
            available_tags = DIAGNOSIS_TAGS + NEURODIVERGENT_TAGS

        row = []
        for t in available_tags:
            prefix = "✅ " if t in draft["tags"] else ""
            row.append(types.InlineKeyboardButton(f"{prefix}#{t}", callback_data=f"{CB_PREFIX_TAG}extra:{t}"))
            if len(row) == 2:
                kb.row(*row)
                row = []
        if row:
        ...
        kb.row(types.InlineKeyboardButton("➡️ Далее к симптомам", callback_data=f"{CB_PREFIX_GOTO}symptoms_ask"))
        kb.row(types.InlineKeyboardButton("❌ Отменить", callback_data=CB_CANCEL))
        ...
        sym_tags = TAGS.get("симптомы", MENTAL_HEALTH_TAGS)
        row = []
        for t in sym_tags:
            prefix = "✅ " if t in draft["symptoms"] else ""
            row.append(types.InlineKeyboardButton(f"{prefix}#{t}", callback_data=f"{CB_PREFIX_TAG}sym:{t}"))
            if len(row) == 2:
                kb.row(*row)
                row = []
        if row:
        ...
        kb.row(types.InlineKeyboardButton("➡️ Перейти к предпросмотру", callback_data=f"{CB_PREFIX_GOTO}preview"))

    elif step == "quick_extra_hashtags":
        all_extra = LIFE_TAGS + MENTAL_HEALTH_TAGS
        row = []
        for t in all_extra:
            prefix = "✅ " if t in draft["tags"] else ""
            row.append(types.InlineKeyboardButton(f"{prefix}#{t}", callback_data=f"{CB_PREFIX_TAG}extra:{t}"))
        ...
        if draft.get("pub_type") in QUICK_PUB_TAGS:
            kb.row(types.InlineKeyboardButton("➕ Добавить хештеги", callback_data=f"{CB_PREFIX_GOTO}quick_extra_hashtags"))
        else:
...
def get_wizard_message_text(draft: dict) -> str:
    ...
    if step == "type_select":
        ...
        return "Выберите хештеги:"
    elif step == "symptoms_ask":
        return "Добавить симптомы/состояния?\n<i>(Бессонница, мелтдаун, гиперфиксация и т.д.)</i>"
    elif step == "symptoms_select":
        return "Выберите симптомы/состояния:"
    elif step == "twcw_ask":
        return "Добавить TW/CW?"
    elif step == "twcw_select":
        return "Выберите предупреждения (TW/CW):"
    elif step == "quick_extra_hashtags":
        return "Выберите дополнительные хештеги:"
    elif step == "preview":
...
def cb_select_pub_type(call: types.CallbackQuery) -> None:
    ...
    if pub_type in QUICK_PUB_TAGS:
        tag_name = QUICK_PUB_TAGS[pub_type]
        draft["tags"].add(tag_name)
        draft["step"] = "preview"
    else:
